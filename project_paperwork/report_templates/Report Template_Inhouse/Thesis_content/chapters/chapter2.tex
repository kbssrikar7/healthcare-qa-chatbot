...
\begin{enumerate}
    \item Build a medical knowledge base from ChatDoctor-HealthCareMagic, PubMedQA, and MedMCQA using a sentence-boundary-aware chunking strategy.
