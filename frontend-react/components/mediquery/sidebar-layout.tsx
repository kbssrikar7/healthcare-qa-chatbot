    ...
    <div className="flex h-dvh overflow-hidden bg-zinc-950 text-zinc-100">
      ...
      <div className="relative flex flex-1 flex-col overflow-hidden">
        ...
        <a
          ...
          className="fixed bottom-2 left-1/2 z-50 -translate-x-1/2 text-lg font-medium tracking-wide text-zinc-100 underline underline-offset-4 decoration-zinc-400 transition-colors hover:text-white hover:decoration-white"
        >
          done by kbssrikar
        </a>
      </div>
