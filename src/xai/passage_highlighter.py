...
class PassageHighlighter:
    ...
    def highlight(
        ...
        for passage in passages:
            ...
            results.append(HighlightedPassage(
                text=passage_text,
    ...
    def _find_best_match(
        ...
        match = matcher.find_longest_match(
            0, len(needle_lower), 0, len(haystack_lower)
        )
        ...
        for span in sorted_spans[1:]:
            ...
            if span.start <= prev.end:
                ...
                merged[-1] = HighlightSpan(
                    ...
                    matched_claim=prev.matched_claim if prev.match_ratio >= span.match_ratio else span.matched_claim,
