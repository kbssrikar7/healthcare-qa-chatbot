...
def main():
    ...
    try:
        ...
        print("Failed to import app components. Ensure you run this from the project root.")
        return
    ...
    if updates > 0:
        ...
        print(f"✅ Updated {updates} test cases with real deterministic IDs from the vector store.")
    else:
