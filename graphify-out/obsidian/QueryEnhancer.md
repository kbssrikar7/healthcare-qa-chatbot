...
- [[._expand_abbreviations()]] - `method` [EXTRACTED]
- [[._expand_with_synonyms()]] - `method` [EXTRACTED]
- [[._llm_expand()]] - `method` [EXTRACTED]
- [[._simple_reformulations()]] - `method` [EXTRACTED]
- [[.decompose_query()]] - `method` [EXTRACTED]
- [[.enhance()]] - `method` [EXTRACTED]
- [[.generate_hypothetical_answer()]] - `method` [EXTRACTED]
...
- [[Backward-compatible wrapper around QueryEnhancer.]] - `uses` [INFERRED]
...
- [[Compatibility shim; prefer ``QueryEnhancer`` directly.]] - `uses` [INFERRED]
...
- [[Enhance queries for better retrieval recall.      Implements patterns from ai-ra]] - `rationale_for` [EXTRACTED]
...
- [[MedicalQueryExpander]] - `uses` [INFERRED]
...
- [[query_enhancer.py]] - `contains` [EXTRACTED]
